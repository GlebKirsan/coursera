...
public:
        ...
        // EvaluateOnValues(), а сами функции ToString() и Evaluate() трогать
        // больше не нужно.
...
private:
        // Введение этих новых вирутальных функций позволяет уменьшить
        // дублирование кода в наследниках, т.к. весь общий код собран в
        // функциях ToString() и Evaluate() базового (данного) класса. А
        // наследники просто сообщают символ операции и применяют её к
        // переданным операндам.
